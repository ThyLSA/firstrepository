package com.devsuperior.myfisrtproject;
...
import com.devsuperior.myfisrtproject.entities.Category;
import com.devsuperior.myfisrtproject.entities.Product;
import com.devsuperior.myfisrtproject.repositories.CategoryRepository;
import com.devsuperior.myfisrtproject.repositories.ProductRepository;

@SpringBootApplication
public class MyfisrtprojectApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(MyfisrtprojectApplication.class, args);
	}
